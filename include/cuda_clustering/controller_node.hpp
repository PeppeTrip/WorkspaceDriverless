...
{
private:
       // original std::shared_ptr<visualization_msgs::msg::Marker> cones{new visualization_msgs::msg::Marker()};
        std::shared_ptr<visualization_msgs::msg::Marker> cones_near{new visualization_msgs::msg::Marker()};
        std::shared_ptr<visualization_msgs::msg::Marker> cones_far{new visualization_msgs::msg::Marker()};
        
        double range_split_m = 4.0;
        ...
        // original rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr cones_array_pub;
        rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr cones_array_pub;
